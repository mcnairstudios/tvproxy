...
var pluginMeta = &gst.PluginMetadata{
	...
	Name:         "tvproxysrc",
	Description:  "TVProxy source bin for HTTP/RTSP/file MPEG-TS inputs",
	Version:      "v0.1.0",
	License:      gst.LicenseLGPL,
	Source:       "tvproxysrc",
	Package:      "tvproxysrc",
	Origin:       "https://github.com/gavinmcnair/tvproxysrc",
...
//export gst_plugin_tvproxysrc_get_desc
func gst_plugin_tvproxysrc_get_desc() unsafe.Pointer { return pluginMeta.Export() }
